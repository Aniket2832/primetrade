    ...
    <div className="bg-animated min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8 fade-up">
          ...
          <p className="text-slate-400 font-body text-sm">Create your account</p>
        </div>
        ...
        <div className="glass-card p-8 fade-up fade-up-delay-1" style={{
          ...
          <h1 className="font-display font-bold text-2xl text-white mb-6">Get started</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPass ? 'text' : 'password'} className="glass-input pr-12"
            ...
            <div>
              ...
              <select className="glass-input" value={form.role}
                ...
                <option value="user" style={{ background: '#0a0f28' }}>👤 User</option>
                <option value="admin" style={{ background: '#0a0f28' }}>🛡️ Admin</option>
              </select>
            </div>
